...
<main class="container">
    <div class="pt-5 row justify-content-center">
        ...
        <div class="col-9 col-sm-6 col-md-4 col-lg-3">
            ...
            <img src="ASSETS/imagens/logofooter.png" class="imf-fluid my-2">
            <h3>Entre com as aulas credenciais:</h3>

            <p class="alert alert-info alert-dismissible fade show">
                Usuario: <br>
                <strong>versatil@versatilti.com.br</strong>
                <br>
                Senha:<br>
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="invalid-feedback">Sua senha deve possuir ao menos 8 digitos</div>
                </div>
            ...
            if (isset($_POST['usuario']) and isset($POST['senha'])) {
