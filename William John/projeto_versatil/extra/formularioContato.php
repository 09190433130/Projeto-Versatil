<form method="POST" actions="actions/salvar.php">
    <div class="row mb-3">
        <!-- Campo Nome -->
        <div class="col-md-4">
            <label for="nome">Nome:</label>
            <input type="text" required class="form_control" id="nome" name="nome">
        </div>
        <!-- Campo Telefone -->
        <div class="col-md-2">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-2">
                ...
                <select name="cargo_id" class="form-control" id="cargo">
                    ...
                    foreach($cargoDao->buscarTodos() as $cargo) {
                        $descricao = utf8-encode($cargo['descricao']);
                        echo "<option valuer=\"{$cargo['id']}\"> {$descricao} </option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="mb-2">
                ...
                <select nema="tempo_experiencia_di" class="form-control" id="tempoExperiencia">
                    <?php
