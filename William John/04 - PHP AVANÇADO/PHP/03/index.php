<html>
 ...
 <p>Parte do corpo: <input type="text" name="parte"/></p>
 ...
 // aqui estamos criando um objeto, ou seja instanciando a classe pessoa e
 // passando um parametro para o construtor
 // nesse caso o nome da pessoa
 $pessoa = new Pessoa($_POST['nome']);
 // chamamos o método criar_corpo e passamos o valor do campo do formulário
  $pessoa->criar_corpo($_POST['parte']);
 // chamamos o método que irá escrever o corpo
 $pessoa->mostra_corpo();
 // aqui destruimos o objeto para executar o destrutor
 unset($pessoa);
 }
 ?>
 </body>
